...
# ---------------------------------------------------------------------------
# Health-check server (satisfies Render free Web Service port requirement)
# ---------------------------------------------------------------------------
...
def run_health_server() -> None:
    ...
    class HealthHandler(BaseHTTPRequestHandler):
        def do_GET(self):
            ...
            self.end_headers()
            self.wfile.write(b"OK - Cricway Bot is running")
...
def main() -> None:
    ...
    # Start health-check server in background thread so Render is satisfied
